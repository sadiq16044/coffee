...
(function($) {
    ...
    RoundSlider.prototype = {
        ...
        _elementDown: function(e) {
            ...
            if ($handleEle) {
                ...
                if (distance >= innerDistance && distance <= outerDistance) {
                    ...
                    if (this._rangeSlider) {
                        var h1Angle = this._handle1.angle,
                            h2Angle = this._handle2.angle,
                            active;
                        if (handle.length == 1) {
        ...
        _changeSliderValue: function(value, angle) {
            ...
            if (!this._showRange) {
                ...
                if (this._minRange || isValidRange || canAllowInvertRange) {
                    ...
                    var dAngle = this._handle2.angle - this._handle1.angle,
                        o2 = "1",
                        o3 = "0";
        ...
        _setSVGAttributes: function() {
            var o = this.options,
                ...
                width = o.width,
                lineCap = o.lineCap,
                borderStyle = o.borderVisibility;
        ...
        _getCenterPoint: function() {
            ...
            var offset = block.offset(),
                center, radius = this.options.radius;
            center = {
        ...
        _limitValue: function(value) {
            var o = this.options,
                ...
                max = o.max,
                isMinHigher = (min > max);
            var _min = isMinHigher ? max : min,
                _max = isMinHigher ? min : max;
    ...
    $.fn.rsRotate = function(degree) {
        var control = this,
            rotation = degree != null ? "rotate(" + degree + "deg)" : "";
